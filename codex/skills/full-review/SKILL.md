---
name: full-review
description: Review a PR or local branch with six independent coding judges and an independent synthesis, present verified findings in Codex's native review UI, and act on the user's scoped decisions. Use for a full harness review, not every implementation task.
---
