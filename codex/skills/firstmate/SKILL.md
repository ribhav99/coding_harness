---
name: firstmate
description: Coordinate software work across Codex app tasks, including starting requested tasks, passing instructions, following progress, and handing work to independent reviewers.
---
