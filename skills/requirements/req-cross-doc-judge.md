...
- **`req-prd-fidelity-judge`** — REQ-level coverage of PRD by tree, OOS alignment, terminology consistency. (You compare tree nodes to *each other*; that judge compares each tree node to the PRD.)
