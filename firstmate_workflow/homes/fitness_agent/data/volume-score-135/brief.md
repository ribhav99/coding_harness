...
1. First action: create your branch: `git checkout -b fm/volume-score-135`

# Rules
1. Never push to the default branch (push only your `fm/volume-score-135` branch). Never merge a PR.
...
4. Report status by appending one line:
   `echo "{state}: {one short line}" >> '/Users/ribhavkapur/Desktop/everything/College/CS/coding_harness/firstmate_workflow/homes/fitness_agent/state/volume-score-135.status'`
