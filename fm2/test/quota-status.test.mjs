...
test('Codex panels install the quota command and Claude panels restore inherited tmux status', () => {
  ...
  assert.equal(configurePanelQuotaStatus('fm-fixture', 'codex', { fm2Home: '/tmp/fm home', run }), true);
  ...
  assert.match(codexStatusRight('fm-fixture', { fm2Home: '/tmp/fm home' }), /fm-fixture/);
});
